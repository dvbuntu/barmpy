...
These calls to `rng.normal` setup original single variable, $X'$, and the noise term, $\eps$.  Next we create a nonlinear function of $X'$ as noted above, first stacking the $X'$ components and then taking a dot product with some $\beta$ coefficients.  Finally, we add the noise term to each data point.
